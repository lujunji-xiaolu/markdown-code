...
const TableRow = (props: RenderElementProps) => <tr {...props.attributes}>{props.children}</tr>;

const TableData = (props: RenderElementProps) => <td {...props.attributes}>{props.children}</td>;
